...
def build_r3d_backbone(): #Official PyTorch R3D-18 model taken from https://github.com/pytorch/vision/blob/master/torchvision/models/video/resnet.py
    ...
    print(model.layer4[0].conv1[0].weight.shape)
...
if __name__ == '__main__':
    ...
    input = torch.rand(4, 3, 16, 112, 112).cuda()
...
#torch.Size([4, 64, 16, 56, 56])
#torch.Size([4, 64, 16, 56, 56])
#torch.Size([4, 128, 8, 28, 28])
#torch.Size([4, 256, 4, 14, 14])
#torch.Size([4, 512, 4, 7, 7])
#torch.Size([4, 512, 4, 1, 1])
